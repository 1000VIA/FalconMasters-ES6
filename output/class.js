...
function (_Usuario) {
  ...
  function Estudiante(nombre, edad, correo, carrera) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Estudiante).call(this, nombre, edad, correo, carrera));
...
var milvia = new Usuario("Milvia ", 30, "correo@correo.com"); // Se hace una instanciá

document.write(milvia.mostarInfo());
var pily = new Estudiante("Lucidia Estela ", 27, "ejemplo@correo.com", "Developer JS");
